...
export default function HouseholdDeliveriesPage() {
  ...
  const fetchDeliveries = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/admin/deliveries?section=HOUSEHOLD');
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      {loading ? (
        <LoadingScreen
          title="Loading Household Deliveries"
          message="Fetching all household delivery orders..."
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold mb-2">Household Essentials Deliveries</h1>
        <p className="text-gray-600">Manage all household delivery requests and track their status</p>
      </div>
